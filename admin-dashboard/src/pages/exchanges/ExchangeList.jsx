            ...
            {data?.map(exchangerate => (
                <CardAction 
                    ...
                    />
                      ...
                      <svg className="hidden xs:block" width="25" height="34" viewBox="0 0 25 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <svg className="block xs:hidden" width="30" height="26" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
