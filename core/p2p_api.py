...
def get_average_price(
    ...
    print("elements: ", len(prices), "list: ", prices)
    cutted_prices = prices[2:-2]

    print("elements: ", len(cutted_prices), "list: ", cutted_prices)
    

    avg_price = Decimal(mean(cutted_prices))
...
def get_sell_rate_to_ves(
    ...
    """
    returns how much Bs VES you can get by SELL 1 origin_currency
    """
...
def get_buy_rate_to_ves(
    ...
    """
    returns how much destination_currency you can BUY by each VES Bs
    """
